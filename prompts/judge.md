...
- **Companies, not people.** Never name an individual as a contact, even if a
  site names its owner or staff. Give a role.
...
- **top_n:** keep at most `target_count`, best first. If fewer qualify, keep
  ...
  reach the number.
- **market_map:** keep everything that is genuinely in the market. The point is
  completeness; the ranking matters less than removing false positives.
